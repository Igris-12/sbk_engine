...
const FilterBar = () => {
  return (
    <div className="flex items-center justify-between p-3 px-6 border-b border-nasa-dark-gray bg-nasa-sidebar-bg/50 backdrop-blur-sm"> {/* Custom colors and blur */}
      ...
      <div className="text-right pr-4"> {/* Adjusted padding */}
